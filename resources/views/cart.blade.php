<x-app-layout>
    ...
    <div class="flex justify-end fixed bottom-10 right-10 z-10">
        <a>
            <button type="submit" class="flex items-center bg-gradient-to-r from-indigo-500 to-blue-500 text-white px-6 py-3 rounded-full shadow hover:from-indigo-600 hover:to-blue-600 focus:outline-none focus:ring-4 focus:ring-indigo-400">
